...
let currentLocation:[string,string,number] = ["Carmen", "10:54", 26]
footer.innerHTML = `Current Location: ${currentLocation[0]} Time: ${currentLocation[1]} Temperature: ${currentLocation[2]}`
